export const clearUserLocalStorage = () => {
  ...
  try {
    ...
    // localStorage.removeItem('chromaflow-agent-preferred-model-v3');
    localStorage.removeItem('customModels');
    localStorage.removeItem('chromaflow-agent-model-selection-v2');
    ...
    localStorage.removeItem('chromaflow-agent_upgrade_dialog_displayed');
