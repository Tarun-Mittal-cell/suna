      ...
      <AlertDialogContent className="max-w-md w-[90vw] p-0 overflow-hidden [&>button]:hidden">
        <div className="relative">
          <AlertDialogHeader className="p-6 pb-4">
            ...
            Would you like a quick guided tour to help you get started? We'll show you the key features and how to make the most of ChromaFlow Agent.
            </AlertDialogDescription>
          </AlertDialogHeader>
