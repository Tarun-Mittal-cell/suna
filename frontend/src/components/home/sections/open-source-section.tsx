        ...
        <div className="max-w-6xl mx-auto border-l border-r border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-x md:divide-y-0 border-t">
            ...
            >
              ...
              {item.showGitHubInfo && (
                <div className="flex flex-col gap-4 mb-4">
                  <div className="flex items-center gap-2 text-primary font-medium">
                    ...
                    <span>chromaflow-ai/chromaflow-agent</span>
                  </div>
              ...
              {item.showGitHubInfo && (
                <Link
                  href="https://github.com/ChromaFlow-ai/ChromaFlow Agent"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-flex h-10 items-center justify-center gap-2 text-sm font-medium tracking-wide rounded-full text-black px-6 shadow-[inset_0_1px_2px_rgba(255,255,255,0.25),0_3px_3px_-1.5px_rgba(16,24,40,0.06),0_1px_1px_rgba(16,24,40,0.08)] bg-secondary hover:bg-secondary/90 transition-all duration-200 w-fit mt-4"
                >
                  <span>View on GitHub</span>
                  <span className="inline-flex items-center justify-center size-5 rounded-full bg-black/10 group-hover:bg-black/20 transition-colors duration-200">
                    <svg
                      width="12"
                      height="12"
                      viewBox="0 0 24 24"
