                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY ChromaFlow AI
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to ChromaFlow AI Corp (701 Tillery Street
                        Unit 12-2521 Austin, Texas 78702, United States).
                      </li>
                      <li>
                        "Site" refers to the ChromaFlow Agent website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the ChromaFlow Agent website and all related
                      ...
                      <li>
                        ...
                        Company, specifically legal@chromaflow.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ChromaFlow Agent is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@chromaflowai.com and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@chromaflowai.com. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All ChromaFlow Agent logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      by emailing us at{' '}
                      <a
                        href="mailto:legal@chromaflowai.com"
                        className="text-secondary hover:underline"
                      >
                        legal@chromaflowai.com
                      </a>
                      .
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at ChromaFlow Agent in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ChromaFlow Agent does not collect biometric or identifying
