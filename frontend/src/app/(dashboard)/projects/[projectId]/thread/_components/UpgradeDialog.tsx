  ...
  return (
    <>
      <UnifiedUpgradeDialog
        ...
        icon={Crown}
        title="Unlock the Full ChromaFlow Agent Experience"
        description="Upgrade to unlock ChromaFlow Agent's full potential. Access our most powerful AI models and enhanced capabilities."
        theme="primary"
        size="sm"
