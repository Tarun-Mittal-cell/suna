...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | ChromaFlow ChromaFlow Agent',
    description: 'Replay this Agent conversation on ChromaFlow ChromaFlow Agent',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | ChromaFlow ChromaFlow Agent';
    const description =
      projectData.description ||
      'Replay this Agent conversation on ChromaFlow ChromaFlow Agent';
