...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Kortix ChromaFlow Agent',
    description: 'Replay this Agent conversation on Kortix ChromaFlow Agent',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Kortix ChromaFlow Agent';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Kortix ChromaFlow Agent';
