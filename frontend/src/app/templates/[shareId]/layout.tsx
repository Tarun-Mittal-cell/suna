...
export async function generateMetadata({ params }: { params: Promise<{ shareId: string }> }): Promise<Metadata> {
  ...
  try {
    ...
    const title = `${template.name} - AI Agent Template | Kortix ChromaFlow Agent`;
    ...
    return {
      title: 'AI Agent Template | Kortix ChromaFlow Agent',
        ...
        images: [
          {
            ...
            width: 1200,
            height: 630,
            alt: 'Kortix ChromaFlow Agent AI Agent Template',
          }
        ],
      },
    };
