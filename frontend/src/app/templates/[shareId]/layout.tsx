...
export async function generateMetadata({ params }: { params: Promise<{ shareId: string }> }): Promise<Metadata> {
  ...
  try {
    ...
    const title = `${template.name} - AI Agent Template | ChromaFlow ChromaFlow Agent`;
    ...
    return {
      title: 'AI Agent Template | ChromaFlow ChromaFlow Agent',
        ...
        images: [
          {
            ...
            width: 1200,
            height: 630,
            alt: 'ChromaFlow ChromaFlow Agent AI Agent Template',
          }
        ],
      },
    };
