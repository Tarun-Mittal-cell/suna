    ...
    <>
      ...
      <section className="mb-12">
        ...
        <DocsBullets variant="check" spacing="default" className="mb-8">
          <DocsBulletItem
            ...
            description="Create your own fork of the ChromaFlow repository on GitHub"
          />
          <DocsBulletItem
            title="Clone Locally"
      ...
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            There are many ways to help improve ChromaFlow:
          </p>
        </DocsBody>
          ...
          <DocsCard
            ...
            actions={[
              { 
                ...
                variant: 'default',
                onClick: () => window.open('https://github.com/chromaflow-ai/chromaflow-agent/issues', '_blank')
              }
            ]}
          />
        </div>
