...
class EmailService:
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to ChromaFlow Agent — Let's Get Started "
...
<body>
  <div class="container">
    ...
    <p>— The ChromaFlow Agent Team</p>

    <a href="https://www.chromaflow_agent.so/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to ChromaFlow Agent — we're excited to have you on board!
...
— The ChromaFlow Agent Team

Go to the platform: https://www.chromaflow_agent.so/

---
© 2025 ChromaFlow Agent. All rights reserved.
You received this email because you signed up for a ChromaFlow Agent account."""
