...
allowed_origins = ["https://www.chromaflow_agent.so", "https://chromaflow_agent.so"]
...
if config.ENV_MODE == EnvMode.STAGING:
    allowed_origins.append("https://staging.chromaflow_agent.so")
    allowed_origins.append("http://localhost:3000")
    allow_origin_regex = r"https://chromaflow_agent-.*-prjcts\.vercel\.app"
